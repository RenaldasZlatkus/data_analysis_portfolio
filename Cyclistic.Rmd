...
knitr::opts_knit$set(root.dir = "C:/Users/renal/OneDrive/Bureaublad/Cyclistic")
```
...
To answer the question, “How do annual members and casual riders use Cyclistic bikes differently?”, provided in the business task I will be using and cleaning data collected between 1st of September 2020 and 31st of August 2021 and will be stored locally on my device.  
...
View(uniq_street_name)
View(c(uniq_street_name[707,], uniq_street_name[726,], uniq_street_name[747,]))
...
```{r Data enrichment OSM, echo=TRUE}
...
```{r Data enrichment NOAA, echo=TRUE}
...
```{r NOAA data cleaning, echo=TRUE}
...
```{r NOAA data merger with main data set, echo=TRUE}
...
```{r Final data cleaning and transforming, echo=TRUE}
...
fwrite(bike_data, file = "cyclistic_data_wrangling_process.csv", sep = ",", na = "NA", row.names = FALSE, col.names = TRUE)
